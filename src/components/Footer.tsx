...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-transparent pt-16 pb-0">
      {/* Main Footer Content */}
      <div className="mx-32 max-md:mx-5 flex gap-8 max-md:flex-col">
        ...
        >
          ...
          >
            Canlife is a company that provides technology and consulting
            services for life insurance. Canlife is licensed as an insurance
            agent in all states where its products are offered. License
            information can be found here. Canlife operates under the name
            Canlife Insurance Services in LA. The information contained on this
            website is for informational purposes only. Certain products and
            product features may not be available in all states, and other
