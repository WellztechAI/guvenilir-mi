                ...
                <div className="flex gap-4 mb-8">
                  ...
                  <button
                    ...
                    style={{
                      fontFamily: "Metropolis, sans-serif",
                      backgroundColor:
                        activeTab === "register" ? "#2d1b69" : "#e8e8ea",
          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p
                ...
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                Senin sesin, milyonların pusulası. Başkalarının karar verme
                sürecine katkı sağla!
              </p>
            </div>
              ...
              {[1, 2, 3].map((_, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p
                        className="font-semibold text-[#202023]"
                        style={{ fontFamily: "Metropolis, sans-serif" }}
                      >
                        Fuat Han Albar
                      </p>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Manrope, sans-serif" }}
                  >
                    İnanılmazyım! 24 ay taksitle kredi çektim ve benden bunun
                    için döküman ve bilgilerimi istediler teyit!
                  </p>
                  ...
                  <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
                    ...
                    <div>
                      <p className="font-medium text-sm text-[#202023]">
                        Garanti BBVA
                      </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Brand 2 */}
                <div
                  className="bg-white rounded-2xl p-5 border border-yellow-200"
                  style={{
