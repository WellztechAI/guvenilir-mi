...
export const UserProfile: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "info" | "favorites" | "comments" | "notifications" | "rewards"
  >("info");
  ...
  useEffect(() => {
    ...
    if (
      tabParam &&
      ["info", "favorites", "comments", "notifications", "rewards"].includes(
        tabParam,
      )
    ) {
      setActiveTab(
  ...
  useEffect(() => {
    const loadFavoriteCompanies = async () => {
      if (
        activeTab === "favorites" &&
        user?.favouriteCompanies &&
        user.favouriteCompanies.length > 0
      ) {
                ...
                <div className="bg-white rounded-lg shadow-sm p-8">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        >
                          İki faktörlü kimlik doğrulama, hesabınıza ekstra bir
                          güvenlik katmanı ekler. Giriş yapmak için ek olarak 6
                          haneli bir kod girmeniz gerekecektir.
                        </p>
                        <button
                          style={{
                            fontFamily: "Metropolis, sans-serif",
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center"
                        style={{
                            ...
                            <div className="flex">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <svg
                                  ...
                                  height="20"
                                  viewBox="0 0 24 24"
                                  fill={star <= Math.round(company.rating ?? 0) ? '#FFD700' : '#E5E7EB'}
                                >
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: "none",
                          backgroundColor:
                            commentFilter === "pending" ? "#6366F1" : "#E5E7EB",
                          color:
                            commentFilter === "pending" ? "#FFFFFF" : "#6B7280",
                        }}
                      >
                        İncelenen
                      </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {displayedComments.map((comment) => (
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                >
                                  {comment.date.toLocaleDateString("tr-TR", {
                                    day: "numeric",
                                    month: "long",
                                    year: "numeric",
                                  })}
                          ...
                          <div className="flex mb-3">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill={
                                  star <= comment.rating ? "#FFD700" : "#E5E7EB"
                                }
                              >
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                              </svg>
                            ...
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <div>
                                ...
                                {comment.answerDate && (
                                  ...
                                  >
                                    {comment.answerDate.toLocaleDateString(
                                      "tr-TR",
                                      {
                                        day: "numeric",
                                        month: "long",
                          ...
                          <button
                            onClick={() =>
                              navigate(`/company/${comment.companyId}`)
                            }
                            style={{
                              fontFamily: "Metropolis, sans-serif",
                              fontSize: "12px",
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex items-start gap-4 flex-1">
                              ...
                              <div className="flex-1">
                                ...
                                >
                                  Tüm mağazalarda kullanabileceğiniz migros
                                  çekiniz.
                                </p>
                                <p
                                  style={{
