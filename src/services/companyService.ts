...
const apiCompanyToCompany = (apiCompany: ApiCompany): Company => ({
  ...
  commentCount: apiCompany.commentCount,
  imageUrl: apiCompany.imageUrl,
...
export const fetchCompany = async (
  ...
  try {
    const response = await api.get<{ data: ApiCompany }>(
 ...
 */
export const fetchCompanyBySlug = async (
  slug: string,
): Promise<Company | null> => {
  try {
    ...
    console.log("API response for slug:", response);
...
export const fetchAllCompanies = async (options?: {
  ...
  try {
    ...
    const response = await api.get<{ data: ApiCompany[]; pagination: any }>(
      url,
    );
 ...
 */
export const fetchCompaniesByStatus = async (
  status: string,
): Promise<Company[]> => {
 ...
 */
export const fetchCompaniesBySector = async (
  sector: string,
): Promise<Company[]> => {
 ...
 */
export const fetchTopRatedCompanies = async (
...
export const searchCompaniesByName = async (
  ...
  try {
    ...
    const response = await api.get<SearchResponse>(
      `/api/search/companies?${params.toString()}`,
    );
    return response.data.map(apiCompanyToCompany);
  } catch (error) {
...
> => {
  try {
    ...
    const response = await api.get<SuggestResponse>(
 ...
 */
export const fetchCompaniesByIds = async (
  companyIds: string[],
): Promise<Company[]> => {
  try {
